            ...
            return (
              <div className="max-w-sm bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out transform hover:scale-105">
                <img
                  ...
                  src="https://cdn2.fptshop.com.vn/unsafe/360x0/filters:quality(100)/phone_cate_c6a412f60a.png"
                  alt="Product Image"
                />
                <div className="p-4">
        ...
        <div className="h-[400px] flex items-center justify-center gap-7">
          <div className="relative w-[660px] h-[350px]">
            <img
              ...
              src="https://www.apple.com/v/iphone-16/c/images/meta/iphone-16_overview__fcivqu9d5t6q_og.png?202411071254"
            />
