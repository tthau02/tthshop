  ...
  return (
    <div className="border rounded-lg p-3 hover:shadow-lg transition">
        <Link to={`/products/${props._id}`}>
            <img className="w-full h-44 object-cover rounded-md mb-3" src={props.thumbnail} alt={props.name} />
        </Link>
        <div className="p-2">
            <Link to={`/products/${props._id}`}>
            ...
            <span className="text-base font-bold text-red-500">{props.price.toLocaleString()}₫</span>
